...
void World::add_world_object_type(const LuaTable& table, FileSystem* map_filesystem, MapObjectType type) {
	...
	case MapObjectType::CRITTER:
		critters_->add(new CritterDescr(
		   _(table.get_string("descname")),files_directory, table, description_manager_->get_attributes(type_name)));
		break;
	case MapObjectType::IMMOVABLE:
		immovables_->add(new ImmovableDescr(type_descname, files_directory, table, MapObjectDescr::OwnerType::kWorld,
