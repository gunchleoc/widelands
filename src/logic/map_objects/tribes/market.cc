...
MarketDescr::MarketDescr(const std::string& init_descname, const std::string& files_directory, const LuaTable& table, Tribes& tribes)
   : BuildingDescr(init_descname, files_directory, MapObjectType::MARKET, table, tribes) {
